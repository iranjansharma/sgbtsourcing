...
export const metadata: Metadata = {
  title: "Industries We Serve – Airlines, Defence, Marine & Institutions | SGTBS Aviation",
  description:
    "SGTBS Aviation supports airlines, defence forces, marine operators and institutional clients with certified aviation spares, OEM supply, and logistics solutions across India.",
  keywords: [],
  openGraph: {
    type: "website",
    siteName: "Aircraft Parts Supply | SGTBS",
    locale: "en_US",
    url: "https://sgtbsourcing.com/industries",
    title: "Industries We Serve – Airlines, Defence, Marine & Institutions | SGTBS Aviation",
    description:
      "SGTBS Aviation supports airlines, defence forces, marine operators and institutional clients with certified aviation spares, OEM supply, and logistics solutions across India.",
    images: [
  ...
  return (
    <main className="pt-16 xs:pt-20 sm:pt-24">
        ...
        <div className="relative z-1 md:mt-6 flex items-center justify-center">
          <div className="text-center max-w-2xl">
            ...
            <p className="mt-6 max-w-[60ch] text-gray-200 xs:text-lg leading-relaxed">
              Trusted sourcing partner delivering certified spares and equipment
              to defense organizations, ensuring readiness and reliability.
            </p>
      ...
      <div className="mx-auto px-4 max-w-7xl sm:px-6 lg:px-8">
        <Features06Page
          HEAD="Industries"
          DESC="Trusted sourcing partner delivering certified spares and equipment to defense organizations, ensuring readiness and reliability."
          features={IndustriesData}
        />
      </div>
    </main>
  );
