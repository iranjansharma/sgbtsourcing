...
export const metadata: Metadata = {
  title: "Our Services – Aviation Procurement, OEM Parts & Engineering Support | SGTBS Aviation",
  description:
    "Explore SGTBS Aviation’s services: aviation procurement, OEM aircraft parts supply, engineering assistance, repair management, and end-to-end logistics for civil & defence sectors.",
  keywords: [],
  openGraph: {
    type: "website",
  ...
  return (
    <main className="pt-16 xs:pt-20 sm:pt-24">
        ...
        <div className="relative z-1 md:mt-6 flex items-center justify-center">
          <div className="text-center max-w-2xl">
            ...
            <p className="mt-6 max-w-[60ch] text-gray-200 xs:text-lg leading-relaxed">
              We deliver end-to-end sourcing and procurement of critical
              aircraft components with speed, reliability, and compliance.
            </p>
      ...
      <div className="mx-auto px-4 max-w-7xl sm:px-6 lg:px-8">
        <Features06Page
          HEAD="Our Services"
          DESC="We deliver end-to-end sourcing and procurement..."
          features={ServiceData}
        />
      </div>
    </main>
  );
